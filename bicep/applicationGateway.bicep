...
resource keyVaultSecretsUserapplicationGatewayManagedIdentityRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: keyVault
  name: guid(keyVault.id, applicationGatewayManagedIdentity.name, 'keyVaultSecretsUser')
  properties: {
...
output principalId string = applicationGatewayManagedIdentity.properties.principalId
